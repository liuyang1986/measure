...
public class MeasureActivity extends Activity implements BtBase.Listener, BtReceiver.Listener, BtDevAdapter.Listener, PermissionInterface {
    private static final String TAG = "Test MeasureActivity";
...
//        }
        ...
        if (android.os.Build.VERSION.SDK_INT >= M) {
            ...
            permissionHelper.requestPermission(mActivity, MeasureActivity.this,
    ...
    {
        LinearLayout llMeasureData = (LinearLayout) LayoutInflater.from(MeasureActivity.this).inflate(R.layout.measure_data_item_midway, null);
...
//
    ...
    private void addFirstBasePointMeasureDataItemView() {
        ...
        final LinearLayout llMeasureData = (LinearLayout) LayoutInflater.from(MeasureActivity.this).inflate(R.layout.measure_data_item_odd, null);
    ...
    private void addOddMeasureDataItemView(final List<String> pointName, final int mpbIndex, final int selectPos) {
        LinearLayout llMeasureData = (LinearLayout) LayoutInflater.from(MeasureActivity.this).inflate(R.layout.measure_data_item_odd, null);
        Spinner spinner = llMeasureData.findViewById(R.id.spin_measure_name_odd);
        ArrayAdapter pointNameAdapter = new ArrayAdapter<>(mActivity,
                R.layout.spinner_item_style, pointName);
        pointNameAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
...
//        updateMeasureStationPoint(mpbIndex - 1);
    ...
    private void addEvenMeasureDataItemView(final List<String> pointName, final int mpbIndex, final int selectedPos) {
        LinearLayout llMeasureData = (LinearLayout) LayoutInflater.from(MeasureActivity.this).inflate(R.layout.measure_data_item_even, null);
